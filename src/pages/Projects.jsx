...
const Projects = () => {
    ...
    const colorBtn =
    (colour === 'red') ? 'flex bg-red-600 px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-1000' :
    (colour === 'green') ? 'flex bg-green-500 px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-1000'  :
    (colour === 'yellow') ? 'flex bg-yellow-300 px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-1000'  :
    (colour === 'purple') ? 'flex bg-[#FF00D6] px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-1000'  :
    (colour === 'orange') ? 'flex bg-orange-500 px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-1000'  :
    (colour === 'blue') ? 'flex bg-[#00E0FF] px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-1000'  :
    '';
  ...
  >
    ...
    <div className="mt-28 lg:mt-20 mx-4 sm:mx-6 md:mx-8 lg:mx-10 2xl:m-20 w-[90%] lg:w-3/4">
      ...
      <div className={lightMode ? 'bg-white mt-4 2xl:mt-10 rounded p-6 2xl:p-10 text-[#002259] max-h-[65vh] md:max-h-[70vh] overflow-y-scroll scrollbar-hide' : 'bg-[#223343] border-2 mt-4 2xl:mt-10 rounded p-6 2xl:p-10 text-white max-h-[65vh] md:max-h-[70vh] overflow-y-scroll scrollbar-hide' }>
        ...
        <div className='xl:flex h-full items-center mt-6'>
            <div className='xl:w-3/5 h-full '>
                ...
                <NavLink to="https://melodic-dango-182072.netlify.app/" className="w-2/5">
                    <img className='flex xl:hidden w-[80%] sm:w-[50%] lg:w-[50%]  mt-10 mx-auto rounded  hover:border-2 hover:border-[#706DFF] transition-all duration-500 cursor-pointer hover:w-[82%] ' src={musskyImg} alt="" />
                </NavLink>
                <div className='flex justify-end gap-3'>
                    <NavLink to="https://github.com/Coldaniel2001/musSky">
                        <div className={!lightMode ? 'flex bg-[#706DFF] px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-500':'flex bg-[#706DFF] border border-black px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-500' }>
                            <img className='hidden md:flex w-6' src={github} alt="" />
                            <p className='text-black font-bold'>{spanishMode ? "Front" : "Front"}</p>
                        </div>
                    </NavLink>
                    <NavLink to="https://github.com/Coldaniel2001/musSky-backend">
                        <div className={!lightMode ? 'flex bg-[#706DFF] px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-500':'flex bg-[#706DFF] border border-black px-3 rounded items-center gap-3 py-1 mt-10 cursor-pointer hover:px-4 hover:py-2 transition-all duration-500' }>
                            <img className='hidden md:flex w-6' src={github} alt="" />
                            <p className=' text-black font-bold'>{spanishMode ? "Back" : "Back"}</p>
                        </div>
                    </NavLink>
                    <NavLink to="https://melodic-dango-182072.netlify.app/">
                        <div className={colorBtn }>
                            <img className='hidden md:flex w-6 ' src={eye} alt="" />
            ...
            <NavLink to="https://melodic-dango-182072.netlify.app/" className="w-2/5">
              <img className='hidden xl:flex w-[80%] mx-auto rounded  hover:border-2 hover:border-[#706DFF] transition-all duration-500 cursor-pointer hover:w-[82%] ' src={musskyImg} alt="" />
            </NavLink>
        </div>
        <hr className='mx-10 2xl:mx-60 my-14 '/>
        <img className='w-40 ' src={minions} alt="" />
        <div className='xl:flex h-full items-center mt-6'>
            <div className='xl:w-3/5 h-full '>
                <p className='font-extrabold text-xl '>{spanishMode ? "APLICACIÓN DE GIFS":"GIFS APP"}</p>
                <p className='mt-6'>{spanishMode ? "La aplicación ofrece diversas funcionalidades, como ver gifs, darle a me gusta, editar, borrar y copiar la url para compartir. Además podrás subir tus Gifs a través de una url externa o desde tu propio dispositivo. Podrás almacenarlos en tres diferentes carpetas en función del tipo de gif y además tendrás almacenados todos los gifs que te gustan en una sola carpeta. Diseño responsive.": "The application offers various functionalities, such asing gifs, liking them, editing, deleting, and copying the URL for sharing. Additionally, you will be able to upload your gifs through an external URL or from your own device. You can store them in three different folders based on the type of gif, and you will also have all the gifs you like stored in a single folder. Responsive design."}</p>
                <NavLink to="https://genuine-khapse-f333c0.netlify.app/" className="w-2/5">
                    <img className='flex xl:hidden w-[80%] sm:w-[50%] lg:w-[50%]  mt-10 mx-auto rounded  hover:border-2 hover:border-[#706DFF] transition-all duration-500 cursor-pointer hover:w-[82%] ' src={minionsImg} alt="" />
                </NavLink>
                <div className='flex justify-end gap-3'>
            ...
            <NavLink to="https://genuine-khapse-f333c0.netlify.app/" className="w-2/5">
                <img className='hidden xl:flex w-[80%] mx-auto rounded  hover:border-2 hover:border-[#706DFF] transition-all duration-500 cursor-pointer hover:w-[82%] ' src={minionsImg} alt="" />
            </NavLink>
        </div>
        <hr className='mx-10 2xl:mx-60 my-14 '/>
        ...
        <div className='xl:flex h-full items-center mt-6'>
            <div className='xl:w-3/5 h-full '>
                ...
                <NavLink to="https://master--nimble-sherbet-5f062c.netlify.app/" className="w-2/5">
                    <img className='flex xl:hidden w-[80%] sm:w-[50%] lg:w-[50%]  mt-10 mx-auto rounded  hover:border-2 hover:border-[#706DFF] transition-all duration-500 cursor-pointer hover:w-[82%] ' src={pdqImg} alt="" />
                </NavLink>
                <div className='flex justify-end gap-3'>
            ...
            <NavLink to="https://master--nimble-sherbet-5f062c.netlify.app/" className="w-2/5">
            <img className='hidden xl:flex w-[80%] mx-auto rounded  hover:border-2 hover:border-[#706DFF] transition-all duration-500 cursor-pointer hover:w-[82%] ' src={pdqImg} alt="" />
            </NavLink>
        </div>
      </div>
